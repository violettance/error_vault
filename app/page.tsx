      ...
      <header className="sticky top-0 z-10 border-b border-gray-800 bg-gray-900 px-4 py-4">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <div className="hidden md:flex md:gap-3">
            <Button
              className={
                pathname === "/" ? "bg-[#8b5cf6] text-white hover:bg-[#7c3aed]" : "bg-gray-800 text-white border border-gray-700 hover:bg-gray-700"
              }
              onClick={() => router.push("/")}
            >
              Yeni Deneme Girişi
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="border-gray-800 bg-gray-900 text-white">
                ...
                <div className="mt-6 flex flex-col gap-4">
                  <Button
                    className={
                      pathname === "/" ? "w-full bg-[#8b5cf6] text-white hover:bg-[#7c3aed]" : "w-full bg-gray-800 text-white border border-gray-700 hover:bg-gray-700"
                    }
                    onClick={() => router.push("/")}
                  >
                    Yeni Deneme Girişi
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      setShowAnalysisDialog(false)
                      if (lastSavedExamId) {
                        router.push(`/analiz?exam_id=${lastSavedExamId}`)
                      } else {
                        toast({
                          title: "Hata",
